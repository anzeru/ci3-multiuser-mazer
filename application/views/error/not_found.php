...
<head>
    ...
    <link rel="stylesheet" href="<?= base_url('assets/dist/') ?>assets/css/pages/error.css">
</head>
    ...
    <div id="error">
        <div class="error-page container">
            <div class="row justify-content-center">
                <div class="col-md-4">
                    <img class="img-error" src="<?= base_url('assets/dist/') ?>assets/images/samples/error-404.png" alt="Not Found">
                    <div class="text-center">
                        <h1 class="error-title">NOT FOUND</h1>
                        <p class='fs-5 text-gray-600'>The page you are looking not found.</p>
                        <a href="<?= base_url('user/profile') ?>" class="btn btn-lg btn-outline-primary mt-3">Go Home</a>
                    </div>
                </div>
            </div>
        </div>
